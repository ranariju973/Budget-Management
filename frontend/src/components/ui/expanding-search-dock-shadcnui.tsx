        ...
        {!isExpanded ? (
          ...
          >
            <motion.div
              ...
              className="relative flex items-center gap-2 overflow-hidden rounded-full backdrop-blur-md"
              style={{
                border: '1px solid var(--color-border)',
                backgroundColor: 'var(--color-surface)',
              }}
            >
              ...
              <input
                ...
                autoFocus
                className="h-12 flex-1 bg-transparent pr-4 text-sm outline-none"
