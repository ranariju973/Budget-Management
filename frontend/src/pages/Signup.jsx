...
const STEPS = [
  { icon: '✏️', title: 'Sign up your account', desc: 'Complete these easy steps to create your account.' },
  { icon: '🔍', title: 'Create your profile', desc: 'Set up your budget preferences and goals.' },
  { icon: '🎉', title: 'Start saving with FinKart', desc: 'Track expenses, set goals, and grow your savings.' },
];
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Your name" maxLength={50}
                className="w-full px-4 py-3 text-sm rounded-xl outline-none transition-colors" style={inputStyle}
            ...
            <button type="submit" disabled={submitting}
              ...
              {submitting ? <div className="w-4 h-4 border-2 rounded-full animate-spin" style={{ borderColor: 'var(--color-surface)', borderTopColor: 'transparent' }} /> : 'Sign Up'}
            </button>
          </form>
